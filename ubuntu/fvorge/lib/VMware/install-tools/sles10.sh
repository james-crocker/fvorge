...
rug service-add --type YUM http://packages.vmware.com/tools/esx/${VMESXVER}/${DISTRO}/${ARCH} vmware-tools-collection
rug packages vmware-tools-collection
rug subscribe -a
rug install -y -c vmware-tools-collection vmware-tools-esx-kmods-smp vmware-tools-esx-nox
