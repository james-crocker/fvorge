...
package OVF::Service::Storage::Multipath::Packages;
...
sub apply ( \% ) {
	...
	my $property = 'service.storage.multipath.packages';
...
sub install ( \% ) {
	...
	OVF::Manage::Packages::install( %options, @{ $multipathVars{packages} } );
...
sub remove ( \% ) {
	...
	OVF::Manage::Packages::remove( %options, @{ $multipathVars{packages} } );
