...
package OVF::Service::Time::NTP::Packages;
...
sub apply ( \% ) {
	...
	my $property = 'service.time.ntp.packages';
...
sub install ( \% ) {
	...
	OVF::Manage::Packages::install( %options, @{ $ntpVars{packages} } );
...
sub remove ( \% ) {
	...
	OVF::Manage::Packages::remove( %options, @{ $ntpVars{packages} } );
