...
# http://communities.vmware.com/thread/334258?start=0&tstart=0 (nperez)
# nperez	 (3 posts since Oct 28, 2011) Nov 3, 2011 1:24 AM (in response to nperez)
# remove_vm.pl
# User: nperez at communities.vmware.com
