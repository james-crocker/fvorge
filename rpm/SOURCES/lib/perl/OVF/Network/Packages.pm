...
sub install ( \% ) {
    ...
    OVF::Manage::Packages::install( %options, @{ $networkVars{'packages-bond'} } );
...
sub remove ( \% ) {
    ...
    OVF::Manage::Packages::remove( %options, @{ $networkVars{'packages-bond'} } );
