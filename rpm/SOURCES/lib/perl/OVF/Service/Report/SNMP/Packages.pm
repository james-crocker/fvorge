...
package OVF::Service::Report::SNMP::Packages;
...
sub apply ( \% ) {
	...
	my $property = 'service.report.snmp.packages';
...
sub install ( \% ) {
	...
	OVF::Manage::Packages::install( %options, @{ $snmpVars{packages} } );
...
sub remove ( \% ) {
	...
	OVF::Manage::Packages::remove( %options, @{ $snmpVars{packages} } );
